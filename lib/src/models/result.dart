...
class Result extends Model {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      "authModelUsednarration": authModelUsed,
      "chargeResponseCodenarration": chargeResponseCode,
      "chargeResponseMessagenarration": chargeResponseMessage,
      "paymentTypenarration": paymentType,
      "paymentPlannarration": paymentPlan,
      "paymentPagenarration": paymentPage,
